...
public class GrupoServiceImpl implements GrupoService {
	...
	/* Este método se copia de controlPorFases con el fin de obtener la lista total de reuniones
	 * que tiene un proyecto -> diferencia del otro que buscará solo el que corresponda AL usuario 
	 * en su respectiva participacion 
	*/
	@Override
	@Transactional(readOnly = true)
		...
		try {
			...
			for (Proyecto xxx : proyecto) {
				...
				for (Reunion reunion : proyectoData.getReuniones()) {
					// reunionesList = new ArrayList<ControlFase_02DTO>();
					fasesList = new ArrayList<ControlFase_03DTO>();
					ControlFase_02DTO dto = new ControlFase_02DTO(); // REUNION
					ControlFase_03DTO dto_2 = new ControlFase_03DTO(); // FASE
